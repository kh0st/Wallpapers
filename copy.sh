#!/bin/bash
### https://github.com/kh0st/multipass
...
echo "¦¦¦ +-+ ¦¦¦+¦¦¦¦¦¦++¦¦¦¦¦¦¦+¦¦¦   ¦¦¦¦¦¦     ¦¦¦  ¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦¦"
echo "+-+     +-+ +-----+ +------++-+   +-++-+     +-+  +-++------++------+"
echo "OFARRELL INSTALL SCRIPTER"
printf "\n%.0s" {1..2}
...
read -p "Do you want Rainbow Border animations disabled? (Y/N): " choice
if [[ "$choice" =~ ^[Yy]$ ]]; then
...
while true; do
  read -rp "${CAT} Would you like to download additional wallpapers? This is roughly 100-200MB (y/n)" WALL
  case $WALL in
    [Yy])
      echo "${NOTE} Downloading additional wallpapers..."
      if git clone "https://github.com/kh0st/Wallpapers.git"; then
          ...
          if cp -R Wallpapers/wallpapers/* ~/Pictures/wallpapers/ >> "$LOG" 2>&1; then
